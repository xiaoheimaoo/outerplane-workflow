...
<script>
      ...
      }(document, "hs-chat", function(){ onWebchatErrorHandler({}); });
      ...
      var onWebchatErrorHandler = function (data) {
           HSInterface.onWebchatError(JSON.stringify(data))
      };
      Helpshift("addEventListener",  "onWebChatError", onWebchatErrorHandler);

      var wcActionSyncEventHandler = function (data){
           HSInterface.wcActionSync(JSON.stringify(data))
      };
      Helpshift("addEventListener",  "wcActionSync", wcActionSyncEventHandler);
   </script>
</html>