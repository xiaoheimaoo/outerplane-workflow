...
public class ShareInviteHelper {
    public static LinkGenerator generateInviteUrl(Context context) {
        ...
        AFa1uSDK aFa1uSDK = (AFa1uSDK) appsFlyerLib;
        LinkGenerator addParameter = new LinkGenerator("af_app_invites").setBaseURL(string, string2, context.getPackageName()).setReferrerUID(appsFlyerUID).setReferrerCustomerId(AFa1uSDK.getMediationNetwork()).addParameter("af_siteid", context.getPackageName());
