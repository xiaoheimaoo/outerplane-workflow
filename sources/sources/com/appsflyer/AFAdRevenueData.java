...
public final class AFAdRevenueData {
    ...
    public final boolean areAllFieldsValid() {
        return (StringsKt.isBlank(this.monetizationNetwork) ^ true) && AFAdRevenueData();
    }
    ...
    public final String toString() {
        ...
        return "AFAdRevenueData(monetizationNetwork=" + str + ", mediationNetwork=" + mediationNetwork + ", currencyIso4217Code=" + str2 + ", revenue=" + this.revenue + ")";
    }
