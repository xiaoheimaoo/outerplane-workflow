...
public final class AFk1vSDK {
    public static void getMonetizationNetwork(int i, int i2, boolean z, int i3, int[] iArr, int[][] iArr2, int[] iArr3) {
        if (!z) {
            getRevenue(iArr);
        }
        int i4 = 0;
        while (i4 < i3) {
            int i5 = i ^ iArr[i4];
            int revenue = i2 ^ getRevenue(i5, iArr2);
            i4++;
            i2 = i5;
            i = revenue;
        }
    ...
    private static int getRevenue(int i, int[][] iArr) {
