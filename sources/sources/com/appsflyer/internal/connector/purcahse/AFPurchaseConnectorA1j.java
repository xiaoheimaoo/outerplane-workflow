...
public final class AFPurchaseConnectorA1j {
    ...
    static {
        ...
        for (int i3 = 0; i3 < 256; i3++) {
            int i4 = equals[i3] & 255;
            InAppPurchaseEvent[i4] = (byte) i3;
            int i5 = i3 << 1;
            if (i5 >= 256) {
                i5 ^= 283;
            }
            ...
            toJsonMap[i4] = i9;
            getOneTimePurchaseOfferDetails[i4] = (i9 >>> 8) | (i9 << 24);
            getQuantity[i4] = (i9 >>> 16) | (i9 << 16);
            getPackageName[i4] = (i9 << 8) | (i9 >>> 24);
        }
        ...
        for (int i11 = 1; i11 < 10; i11++) {
            ...
            stopObservingTransactions[i11] = i10 << 24;
        }
    }

    public static byte[][] toJsonMap(int i) {
    ...
    public static int[] getPackageName(byte[] bArr, int i) throws IllegalArgumentException {
        if (bArr.length != 16) {
        ...
        while (i10 < i3) {
            ...
            if (i11 == 0) {
                byte[] bArr2 = equals;
                i13 = ((bArr2[i13 >>> 24] & 255) | (((bArr2[(i13 >>> 16) & 255] << Ascii.CAN) | ((bArr2[(i13 >>> 8) & 255] & 255) << 16)) | ((bArr2[i13 & 255] & 255) << 8))) ^ stopObservingTransactions[i12];
                i11 = 4;
                i12++;
            }
