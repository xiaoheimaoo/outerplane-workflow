...
public class Subscriber {
    ...
    public final void dispatchEvent(final Object event) {
        this.executor.execute(new Runnable() { // from class: com.google.common.eventbus.Subscriber$$ExternalSyntheticLambda0
            ...
            public final void run() {
                Subscriber.this.m127lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(event);
            }
        });
    }
    ...
    public /* synthetic */ void m127lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(Object obj) {
        try {
