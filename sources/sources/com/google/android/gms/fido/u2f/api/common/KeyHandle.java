...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    public static KeyHandle parseFromJson(JSONObject jSONObject) throws JSONException {
        try {
            try {
                return new KeyHandle(Base64.decode(jSONObject.getString(SignResponseData.JSON_RESPONSE_DATA_KEY_HANDLE), 8), ProtocolVersion.fromString(jSONObject.has(MediationMetaData.KEY_VERSION) ? jSONObject.getString(MediationMetaData.KEY_VERSION) : null), jSONObject.has("transports") ? Transport.parseTransports(jSONObject.getJSONArray("transports")) : null);
