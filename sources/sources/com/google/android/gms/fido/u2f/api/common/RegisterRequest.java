...
public class RegisterRequest extends AbstractSafeParcelable {
    ...
    public static RegisterRequest parseFromJson(JSONObject jSONObject) throws JSONException {
        try {
            try {
                try {
                    return new RegisterRequest(ProtocolVersion.fromString(jSONObject.has(MediationMetaData.KEY_VERSION) ? jSONObject.getString(MediationMetaData.KEY_VERSION) : null), Base64.decode(jSONObject.getString(ClientData.KEY_CHALLENGE), 8), jSONObject.has("appId") ? jSONObject.getString("appId") : null);
