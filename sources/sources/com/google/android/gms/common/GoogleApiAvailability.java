...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void setDefaultNotificationChannelId(Context context, String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(((NotificationManager) Preconditions.checkNotNull(context.getSystemService(ConfigValues.SOURCE_NOTIFICATION))).getNotificationChannel(str));
        }
        synchronized (zaa) {
            this.zac = str;
        }
    ...
    final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            NotificationManager notificationManager = (NotificationManager) Preconditions.checkNotNull(context.getSystemService(ConfigValues.SOURCE_NOTIFICATION));
