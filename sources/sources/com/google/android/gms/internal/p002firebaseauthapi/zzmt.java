...
public final class zzmt {
    ...
    private static zzms zza(zzms zzmsVar, zzms zzmsVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod = zzmsVar.zzd.multiply(zzmsVar.zzd).mod(bigInteger2);
        BigInteger mod2 = zzmsVar2.zzd.multiply(zzmsVar2.zzd).mod(bigInteger2);
    ...
    private static zzms zza(zzms zzmsVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod = zzmsVar.zzb.multiply(zzmsVar.zzb).mod(bigInteger2);
        BigInteger mod2 = zzmsVar.zzc.multiply(zzmsVar.zzc).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmsVar.zzd.multiply(zzmsVar.zzd).mod(bigInteger2);
