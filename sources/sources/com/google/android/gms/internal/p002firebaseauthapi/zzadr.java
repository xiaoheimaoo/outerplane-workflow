...
public final class zzadr {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzadr.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzzs zzzsVar, FirebaseUser firebaseUser) {
        zzw.zza(firebaseAuth);
        zzw.zza(zzzsVar);
        Pair<String, String> pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzal.zza(zzzsVar, firebaseAuth, firebaseUser));
    }
