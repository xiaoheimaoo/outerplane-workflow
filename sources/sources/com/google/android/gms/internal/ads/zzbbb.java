...
public final class zzbbb extends AbstractSafeParcelable {
    ...
    public zzbbb(String str, long j, String str2, String str3, String str4, Bundle bundle, boolean z, long j2, String str5, int i) {
        this.zza = str;
        this.zzb = j;
        ...
        try {
            if ("gcache".equals(uri.getScheme())) {
                ...
                if (pathSegments.size() != 2) {
                    ...
                    zzcec.zzj("Expected 2 path parts for namespace and id, found :" + size);
                    return null;
                }
            ...
            zzcec.zzk("Unable to parse Uri into cache offering.", e);
            return null;
        }
    }
