...
public class HttpGetRequest {
    ...
    private String createParamsString(Map<String, String> map) throws UnsupportedEncodingException {
        ...
        sb.append(next.getKey()).append("=").append(next.getValue() != null ? URLEncoder.encode(next.getValue(), Constants.ENCODING) : "");
        while (it.hasNext()) {
            Map.Entry<String, String> next2 = it.next();
            sb.append("&").append(next2.getKey()).append("=").append(next2.getValue() != null ? URLEncoder.encode(next2.getValue(), Constants.ENCODING) : "");
        }
        return sb.toString();
    }
