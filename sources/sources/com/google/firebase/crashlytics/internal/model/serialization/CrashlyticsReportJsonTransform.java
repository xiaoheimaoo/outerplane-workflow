        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 104069929:
                    ...
                    break;
                case 109757585:
                    if (nextName.equals(AdOperationMetric.INIT_STATE)) {
                        c = 7;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 107332:
                    ...
                    break;
                case 3575610:
                    if (nextName.equals(HelpshiftEvent.DATA_MESSAGE_TYPE)) {
                        c = 4;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case 3373707:
                    ...
                    break;
                case 3530753:
                    if (nextName.equals(HelpshiftEvent.DATA_SIZE)) {
                        c = 1;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -887523944:
                    ...
                    break;
                case 3571:
                    if (nextName.equals(Constants.REVENUE_PRODUCT_CATEGORY_KEY)) {
                        c = 2;
                        break;
                    }
                    break;
