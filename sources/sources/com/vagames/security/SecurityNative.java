...
public class SecurityNative {
    private static final String SECRET_SALT = "xqvmpzjlrkdnwacytfohbeugs";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":xqvmpzjlrkdnwacytfoh:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
