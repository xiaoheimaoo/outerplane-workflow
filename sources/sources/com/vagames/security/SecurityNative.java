...
public class SecurityNative {
    private static final String SECRET_SALT = "qkzvtnmecjrwuxhysadyfbopl";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":qkzvtnmecjrwuxhysady:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
