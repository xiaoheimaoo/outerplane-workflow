...
public class SecurityNative {
    private static final String SECRET_SALT = "xqmpvntzlrhbkfaywseogdicu";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":xqmpvntzlrhbkfaywseo:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
