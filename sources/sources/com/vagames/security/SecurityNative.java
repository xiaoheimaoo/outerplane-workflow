...
public class SecurityNative {
    private static final String SECRET_SALT = "kzqmxvnapwtehjcfyurbdslgo";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":kzqmxvnapwtehjcfyurb:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
