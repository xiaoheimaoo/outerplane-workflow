...
public class SecurityNative {
    private static final String SECRET_SALT = "xqmntzvprkahlfeycdbjsoiug";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":xqmntzvprkahlfeycdbj:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
