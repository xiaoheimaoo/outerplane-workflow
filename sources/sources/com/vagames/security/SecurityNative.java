...
public class SecurityNative {
    private static final String SECRET_SALT = "qmxzrvbnlfktyhpsdcwageuij";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":qmxzrvbnlfktyhpsdcwa:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
