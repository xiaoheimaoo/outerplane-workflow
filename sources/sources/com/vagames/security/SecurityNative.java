...
public class SecurityNative {
    private static final String SECRET_SALT = "xqjvnmtrpazklycwhsdeubgfi";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":xqjvnmtrpazklycwhsde:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
