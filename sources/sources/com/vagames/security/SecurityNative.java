...
public class SecurityNative {
    private static final String SECRET_SALT = "xqmvkztnrjafhuwcpselyobdi";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":xqmvkztnrjafhuwcpsel:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
