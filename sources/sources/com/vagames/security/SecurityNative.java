...
public class SecurityNative {
    private static final String SECRET_SALT = "qmxvtrazkplnwdjhfucyegbos";
    ...
    public static String getClientToken(Context context, String str) {
        ...
        return sha256((packageName + ":" + str + ":qmxvtrazkplnwdjhfucy:" + getSigningCertSha256Fingerprint(context)).toLowerCase());
    }
