...
public final class DurationKt {
    ...
    private static final long m1992timesmvk6XK0(int i, long j) {
        return Duration.m1904timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1991timeskIfJnKk(double d, long j) {
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1866constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1866constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1866constructorimpl((j << 1) + i);
    }
