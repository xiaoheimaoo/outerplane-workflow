...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1858plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1902plusLRDsOJo(this.offset, j), null);
        }
        ...
        public long mo1857minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1871equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1898isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m1968getZEROUwyO8pc();
                    }
                    long m1901minusLRDsOJo = Duration.m1901minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) obj).timeSource) && Duration.m1871equalsimpl0(mo1857minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m1968getZEROUwyO8pc());
        }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1915toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1968getZEROUwyO8pc(), null);
    }
}
