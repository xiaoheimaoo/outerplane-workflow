...
public interface TimeMark {
    ...
    TimeMark mo1856minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1858plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2003plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m2002minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1858plusLRDsOJo(Duration.m1918unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1899isNegativeimpl(timeMark.mo1855elapsedNowUwyO8pc());
        }
