...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1856minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo1857minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1858plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1861minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1858plusLRDsOJo(Duration.m1918unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1865compareToLRDsOJo(comparableTimeMark.mo1857minusUwyO8pc(other), Duration.Companion.m1968getZEROUwyO8pc());
        }
    }
}
