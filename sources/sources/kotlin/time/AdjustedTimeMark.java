...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1856minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2002minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1860getAdjustmentUwyO8pc() {
    ...
    public long mo1855elapsedNowUwyO8pc() {
        return Duration.m1901minusLRDsOJo(this.mark.mo1855elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1858plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1902plusLRDsOJo(this.adjustment, j), null);
    }
}
