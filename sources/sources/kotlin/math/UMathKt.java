...
public final class UMathKt {
    ...
    private static final int m1764minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1746minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1765mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1754minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1762maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1734maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1763maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1742maxOfeb3DHEI(j, j2);
    }
}
