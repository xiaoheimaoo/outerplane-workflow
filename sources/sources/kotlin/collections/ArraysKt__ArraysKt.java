        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m1110contentEqualskV0jMPg(((UByteArray) t).m625unboximpl(), ((UByteArray) t2).m625unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m1107contentEqualsFGO6Aew(((UShortArray) t).m888unboximpl(), ((UShortArray) t2).m888unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m1108contentEqualsKJPZfPQ(((UIntArray) t).m704unboximpl(), ((UIntArray) t2).m704unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m1112contentEqualslec5QzE(((ULongArray) t).m783unboximpl(), ((ULongArray) t2).m783unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m1124contentToString2csIQuQ(uByteArray != null ? uByteArray.m625unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m1128contentToStringd6D3K8(uShortArray != null ? uShortArray.m888unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m1127contentToStringXUkPCBk(uIntArray != null ? uIntArray.m704unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m1130contentToStringuLth9ew(uLongArray != null ? uLongArray.m783unboximpl() : null));
            } else {
