...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static final /* synthetic */ ULongArray m767boximpl(long[] jArr) {
    ...
    public static boolean m772equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual(jArr, ((ULongArray) obj).m783unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m772equalsimpl(this.storage, obj);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m782containsVKZWuLQ(((ULong) obj).m766unboximpl());
        }
        return false;
    }
    ...
    public static final long m774getsVKNKU(long[] jArr, int i) {
        return ULong.m714constructorimpl(jArr[i]);
    }
    ...
    public static java.util.Iterator<ULong> m778iteratorimpl(long[] jArr) {
    ...
    public static final class Iterator implements java.util.Iterator<ULong>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ ULong next() {
            return ULong.m708boximpl(m784nextsVKNKU());
        }
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m771containsAllimpl(this.storage, elements);
    }
    ...
    public static boolean m771containsAllimpl(long[] jArr, Collection<ULong> elements) {
        ...
        for (Object obj : collection) {
            if ((obj instanceof ULong) && ArraysKt.contains(jArr, ((ULong) obj).m766unboximpl())) {
                z = true;
                continue;
            } else {
                z = false;
