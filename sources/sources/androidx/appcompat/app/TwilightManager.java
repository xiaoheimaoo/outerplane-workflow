...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - Utils.TIME_24HRS_MILLIS, location.getLatitude(), location.getLongitude());
        ...
        twilightCalculator.calculateTwilight(Utils.TIME_24HRS_MILLIS + currentTimeMillis, location.getLatitude(), location.getLongitude());
