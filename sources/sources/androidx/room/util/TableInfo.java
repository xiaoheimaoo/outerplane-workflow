...
public class TableInfo {
    ...
    private static Set<ForeignKey> readForeignKeys(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = query.getColumnIndex(UnityNotificationManager.KEY_ID);
    ...
    private static Map<String, Column> readColumns(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            if (query.getColumnCount() > 0) {
                ...
                int columnIndex2 = query.getColumnIndex(HelpshiftEvent.DATA_MESSAGE_TYPE);
                int columnIndex3 = query.getColumnIndex("notnull");
                int columnIndex4 = query.getColumnIndex(Constants.REVENUE_PRODUCT_SKU_KEY);
