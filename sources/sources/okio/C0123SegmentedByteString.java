...
public final class C0123SegmentedByteString extends ByteString {
    ...
    public C0123SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int i, int i2) {
        C0123SegmentedByteString c0123SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0123SegmentedByteString, i2);
        if (!(i >= 0)) {
        ...
        if (resolveDefaultParameter <= size()) {
            ...
            if (i == 0 && resolveDefaultParameter == size()) {
                return c0123SegmentedByteString;
            }
