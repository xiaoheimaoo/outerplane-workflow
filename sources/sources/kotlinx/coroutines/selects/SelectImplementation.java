        ...
        while (true) {
            ...
            if (!(obj3 instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj3, symbol3)) {
                    if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, obj3, CollectionsKt.listOf(obj))) {
                        return 1;
                    }
                } else if (!(obj3 instanceof List)) {
                    throw new IllegalStateException(("Unexpected state: " + obj3).toString());
                } else {
                    if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, obj3, CollectionsKt.plus((Collection<? extends Object>) obj3, obj))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (findClause == null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, obj3, findClause)) {
