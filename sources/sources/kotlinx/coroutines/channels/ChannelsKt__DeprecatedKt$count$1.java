...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", f = "Deprecated.kt", i = {0, 0}, l = {487}, m = HelpshiftEvent.DATA_MESSAGE_COUNT, n = {HelpshiftEvent.DATA_MESSAGE_COUNT, "$this$consume$iv$iv"}, s = {"L$0", "L$1"})
