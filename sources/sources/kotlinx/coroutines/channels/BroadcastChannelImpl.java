...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (this.lastConflatedElement != BroadcastChannelKt.access$getNO_ELEMENT$p()) {
                subscriberConflated.mo2042trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo2042trySendJP2dKIU(E e) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2042trySendJP2dKIU(e);
            }
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2042trySendJP2dKIU(e);
            }
