...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filter$1", f = "Deprecated.kt", i = {0, 1, 1, 2}, l = {198, 199, 199}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", Constants.RequestBody.EXTRA_ATTRIBUTES_KEY, "$this$produce"}, s = {"L$0", "L$0", "L$2", "L$0"})
