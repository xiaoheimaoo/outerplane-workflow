...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2046receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2046receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2047tryReceivePtdJZtk() {
        return this._channel.mo2047tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2042trySendJP2dKIU(E e) {
        return this._channel.mo2042trySendJP2dKIU(e);
    }
