...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2070trySendImplMj0NB7M = conflatedBufferedChannel.m2070trySendImplMj0NB7M(e, true);
        if (m2070trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2056exceptionOrNullimpl(m2070trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2070trySendImplMj0NB7M = conflatedBufferedChannel.m2070trySendImplMj0NB7M(e, true);
        if (!(m2070trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m2070trySendImplMj0NB7M;
    ...
    public Object mo2042trySendJP2dKIU(E e) {
        return m2070trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m2070trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2068trySendDropLatestMj0NB7M(e, z) : m2069trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m2068trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2042trySendJP2dKIU = super.mo2042trySendJP2dKIU(e);
        if (ChannelResult.m2062isSuccessimpl(mo2042trySendJP2dKIU) || ChannelResult.m2060isClosedimpl(mo2042trySendJP2dKIU)) {
            return mo2042trySendJP2dKIU;
        }
        ...
        return ChannelResult.Companion.m2067successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU  reason: not valid java name */
    private final Object m2069trySendDropOldestJP2dKIU(E e) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m2065closedJP2dKIU(getSendException());
                }
            } else {
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        Object mo2042trySendJP2dKIU = mo2042trySendJP2dKIU(obj);
        if (!(mo2042trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo2042trySendJP2dKIU;
            selectInstance.selectInRegistrationPhase(Unit.INSTANCE);
        } else if (!(mo2042trySendJP2dKIU instanceof ChannelResult.Closed)) {
            throw new IllegalStateException("unreachable".toString());
        } else {
            ChannelResult.m2056exceptionOrNullimpl(mo2042trySendJP2dKIU);
