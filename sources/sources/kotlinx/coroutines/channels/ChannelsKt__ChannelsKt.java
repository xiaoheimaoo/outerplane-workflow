...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo2042trySendJP2dKIU = sendChannel.mo2042trySendJP2dKIU(e);
        if (mo2042trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m2064unboximpl();
        }
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) {
        if (ChannelResult.m2062isSuccessimpl(sendChannel.mo2042trySendJP2dKIU(obj))) {
            return;
        }
