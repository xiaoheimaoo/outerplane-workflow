...
public interface SendChannel<E> {
    ...
    Object mo2042trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m2062isSuccessimpl(mo2042trySendJP2dKIU)) {
                return true;
            }
            Throwable m2056exceptionOrNullimpl = ChannelResult.m2056exceptionOrNullimpl(mo2042trySendJP2dKIU);
