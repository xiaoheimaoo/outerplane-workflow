...
public final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (obj == symbol2) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater2, this, obj, symbol3)) {
                    return;
                }
            } else {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater3 = _state$FU;
                symbol4 = StateFlowKt.NONE;
                if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater3, this, obj, symbol4)) {
                    Result.Companion companion = Result.Companion;
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m539constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(_state$FU.get(this) instanceof CancellableContinuationImpl))) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$FU;
            symbol = StateFlowKt.NONE;
            if (!UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, symbol, cancellableContinuationImpl2)) {
