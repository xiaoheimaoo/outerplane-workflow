...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object obj, Throwable th) {
        ...
        while (true) {
            ...
            if (obj2 instanceof CompletedContinuation) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj2, new CompletedContinuation(obj2, null, null, null, th, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new CancelledContinuation(cancellableContinuationImpl, th, z)));
    ...
    private final void invokeOnCancellationImpl(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Active) {
                if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj2, obj)) {
                    return;
                }
            } else {
                if (obj2 instanceof CancelHandler ? true : obj2 instanceof Segment) {
                    ...
                    if (z) {
                        ...
                        if (completedContinuation.getCancelled()) {
                            ...
                            if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                                return;
                            }
                        }
                        ...
                        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj2, new CompletedContinuation(obj2, (CancelHandler) obj, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
    ...
    private final void resumeImpl(Object obj, int i, Function1<? super Throwable, Unit> function1) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj2, resumedState((NotCompleted) obj2, obj, i, function1, null)));
        detachChildIfNonResuable();
        dispatchResume(i);
    }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj3, resumedState((NotCompleted) obj3, obj, this.resumeMode, function1, obj2)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
