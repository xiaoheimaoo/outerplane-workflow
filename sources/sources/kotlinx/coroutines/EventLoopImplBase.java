...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    */
    ...
    public final void mo2098dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (UByte$$ExternalSyntheticBackport0.m(_queue$FU, this, (Object) null, runnable)) {
                    return true;
                }
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, (Object) null, new DelayedTaskQueue(j));
            Object obj = atomicReferenceFieldUpdater.get(this);
