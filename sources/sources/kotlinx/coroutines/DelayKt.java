...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2099scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2029delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2030toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2030toDelayMillisLRDsOJo(long j) {
        if (Duration.m1865compareToLRDsOJo(j, Duration.Companion.m1968getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1884getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
