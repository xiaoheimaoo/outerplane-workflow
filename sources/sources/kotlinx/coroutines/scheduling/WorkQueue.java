...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean z) {
        ...
        do {
            ...
            return null;
        } while (!UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, task, (Object) null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int i, boolean z) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == z && UByte$$ExternalSyntheticBackport0.m(this.buffer, i2, task, (Object) null)) {
                if (z) {
    ...
    private final long tryStealLastScheduled(int i, Ref.ObjectRef<Task> objectRef) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, (Object) r1, (Object) null));
