...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode lockFreeLinkedListNode, Object obj) {
            ...
            if (lockFreeLinkedListNode2 != null && UByte$$ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, lockFreeLinkedListNode2) && z) {
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        while (getNext() == this) {
            if (UByte$$ExternalSyntheticBackport0.m(_next$FU, this, this, lockFreeLinkedListNode)) {
    ...
    public final boolean addNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, lockFreeLinkedListNode2, lockFreeLinkedListNode)) {
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2, CondAddOp condAddOp) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, lockFreeLinkedListNode2, condAddOp)) {
    ...
    public final void finishAdd(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_prev$FU, lockFreeLinkedListNode, lockFreeLinkedListNode2, this));
        if (isRemoved()) {
            lockFreeLinkedListNode.correctPrev(null);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0042, code lost:
        if (kotlin.UByte$$ExternalSyntheticBackport0.m(r4, r3, r2, ((kotlinx.coroutines.internal.Removed) r5).ref) != false) goto L23;
     */
    /*
    ...
    */
    private final kotlinx.coroutines.internal.LockFreeLinkedListNode correctPrev(kotlinx.coroutines.internal.OpDescriptor r9) {
        ...
        L16:
            ...
            boolean r0 = kotlin.UByte$$ExternalSyntheticBackport0.m(r1, r8, r0, r2)
            if (r0 != 0) goto L1f
            goto L0
        L1f:
            return r2
        ...
        L34:
            ...
            boolean r2 = kotlin.UByte$$ExternalSyntheticBackport0.m(r4, r3, r2, r5)
            if (r2 != 0) goto L45
            goto L0
        L45:
            r2 = r3
